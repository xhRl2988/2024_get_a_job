...
const addNoteButton = notesContainer.querySelector(".add-note"); // 수정됨
...
function createNote(id, content){
    ...
    const decorateTextButtons = createTextDecorationButtons(id, noteElement); // 수정됨
...
function bold(){
    var span = document.createElement("span"); // 수정됨
    ...
    if(window.getSelection){
        ...
        if(text.rangeCount){
            ...
            range.surroundContents(span); // 수정됨
