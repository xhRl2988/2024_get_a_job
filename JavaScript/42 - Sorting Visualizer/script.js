    ...
    do{
        ...
        for(let i=1; i<array.length; i++){
            moves.push({
                indices: [i-1, i],
                type: 'comp'
            });//we require type swap because we need to differentiate when we are comparing and when we are swapping to show respective move color.
...
//render the bars dyamically in the index html file
